...
class Box: 
    ...
    def __init__(self, num=-1, x=0, y=0, x0=0, y0=0, double=False, box_color=None):
...
def drawBoard():
    global box, redbox, bluebox, greenbox, yellowbox, redhome, bluehome, yellowhome, greenhome, red, blue, yellow, green
    box = [Box(box_color="red") for i in range(52)]  # list of co-ordinates of all the outer boxes
